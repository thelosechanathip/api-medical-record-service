...
// Remove Start #################################################################################################################################
// Remove ข้อมูล form_opd_er_review_status_results จำนวนหลาย record อ้างอิงจาก form_opd_er_id
exports.RemoveFormOpdErReviewStatusResult = async (form_opd_er_id) =>
    await pm.form_opd_er_review_status_results.deleteMany({ where: { form_opd_er_id: form_opd_er_id } })

// Remove ข้อมูล form_opd_er_content_of_medical_record_results จำนวนหลาย record อ้างอิงจาก form_opd_er_id
exports.RemoveFormOpdErContentOfMedicalRecordResult = async (form_opd_er_id) =>
    await pm.form_opd_er_content_of_medical_record_results.deleteMany({ where: { form_opd_er_id: form_opd_er_id } })

exports.RemoveFormClinicalDetailResult = async (form_opd_er_id) =>
    await pm.form_opd_er_clinical_detail_results.deleteMany({ where: { form_opd_er_id: form_opd_er_id } })

exports.RemovePdf = async (form_opd_er_id) => await pm.pdf_opd_er.deleteMany({ where: { form_opd_er_id: form_opd_er_id } })

// Remove ข้อมูล form_opd_ers จำนวน 1 record อ้างอิงจาก form_opd_er_id
exports.RemoveFormOpdEr = async (form_opd_er_id) =>
    await pm.form_opd_ers.delete({ where: { form_opd_er_id: form_opd_er_id } })
...
exports.FetchOnePatientService = async () =>
    await pm.patient_services.findFirst({ select: { patient_service_id: true }, where: { patient_service_name_english: 'OPD/ER' } })
...
// ดึงข้อมูล form_opd_er_id จำนวน 1 record จากตาราง form_opd_ers อ้างอิงจาก patient_id
exports.FetchPatientIdInFormOpdEr = async (patient_id) =>
    await pm.form_opd_ers.findFirst({ where: { patient_id: patient_id }, select: { form_opd_er_id: true } })
...
/*
    ดึงข้อมูลทั้งหมดของตาราง form_opd_ers
    join
        patients, form_opd_er_content_of_medical_record_results, form_opd_er_overall_finding_results, form_opd_er_review_status_results
    อ้างอิงจาก
        patient_id
*/
exports.FetchOneMedicalRecordAuditOpdEr = async (patient_id) => {
    return await pm.form_opd_ers.findMany({
        where: {
        ...
        include: {
            ...
            form_opd_er_content_of_medical_record_results: {
                include: {
            ...
            form_opd_er_clinical_detail_results: {
                include: {
                    clinical_detail_id: false,
                    clinical_details: {}
                }
            },
            form_opd_er_review_status_results: {
                include: {
...
// บันทึกข้อมูลไปยังตาราง form_opd_ers
exports.InsertFormOpdEr = async (data) => await pm.form_opd_ers.create({ data: { ...data } })

exports.InsertFormOpdErClinicalDetailResult = async (data) => await pm.form_opd_er_clinical_detail_results.create({ data: { ...data } })

// บันทึกข้อมูลไปยังตาราง form_opd_er_content_of_medical_record_results แบบหลาย record พร้อมกัน
exports.InsertFormOpdErContentOfMedicalRecordResult = async (data) =>
    await pm.form_opd_er_content_of_medical_record_results.createMany({ data: data })